...
# Replacing $COMPANY_IDENTIFIER, $DATE_PREPARED, and 
# $GENERIC_1
company_name = "Mike Co., Ltd"
date_prepared = "April 1st, 2026" 
generic_1 = ("This was prepared unter the terms of the "
             "contract DS457/A.")
...
p = document.add_paragraph("A paragraph at the end of the document ")
