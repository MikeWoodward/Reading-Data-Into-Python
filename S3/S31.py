...
def get_folders(client, bucket):
  """Gets the full folder structure. 
  Recursive function."""
  def recursive(client, 
                bucket, 
                folders, 
                prefix):
...
def get1000(client, bucket):
  ...
  with open('the1000.csv', 'w') as file1000:
    the1000 = client.list_objects_v2(
      Bucket=bucket)
...
def getmore1000(client, bucket):
  ...
  # Iterate through the bucket and write keys to 
  # disk
  key_count = 0
